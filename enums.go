...
var (
	CloseTicketUnderlyingCause_name = map[int64]string{
		0:  "Unknown Cause/Other",
		1:  "Licensing",
		2:  "Hardware Failure",
		3:  "Hardware - non-failure",
		4:  "Software Bug",
		5:  "Software -not a bug",
		6:  "Documentation/Tools",
		7:  "Debug/Diagnostic Capabilities",
		8:  "Design Assistance Needed",
		9:  "Configuration Assistance",
		10: "Usability -other than config",
		11: "Interoperability/Compatibility",
		12: "Non-Cisco product or service problem",
		13: "External Environment issue",
	}
